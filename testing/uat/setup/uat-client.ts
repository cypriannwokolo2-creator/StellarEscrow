...
const BASE_URL = process.env.UAT_BASE_URL || process.env.API_BASE_URL || 'http://localhost:3000';
...
export const api: AxiosInstance = axios.create({
  ...
  validateStatus: () => true, // Don't throw on non-2xx — UAT tests check status explicitly
});
