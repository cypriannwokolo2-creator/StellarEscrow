...
variable "stickiness_duration"        { type = number; default = 86400 }  # 1 day
...
variable "autoscaling_max_capacity"   { type = number; default = 4 }
variable "scale_out_cpu_threshold"    { type = number; default = 70 }
variable "scale_in_cpu_threshold"     { type = number; default = 30 }
variable "scale_out_request_threshold"{ type = number; default = 1000 }
