...
variable "db_name"     { type = string; default = "stellar_escrow" }
variable "db_username" { type = string; default = "indexer";        sensitive = true }
...
variable "db_backup_window"      { type = string; default = "03:00-04:00" }
variable "db_maintenance_window" { type = string; default = "Mon:04:00-Mon:05:00" }

# ── API ───────────────────────────────────────────────────────────────────────
variable "api_image"          { type = string; default = "stellarescrow/api:latest" }
variable "api_cpu"            { type = number; default = 256 }
variable "api_memory"         { type = number; default = 512 }
variable "api_container_port" { type = number; default = 3000 }
...
variable "stellar_contract_id" { type = string; default = "" }
